...
//имя пользователя AutoCAD которому назначен узел
...
//	             АCTION=1 - РЕДАКТИРОВАНИЕ ДОКУМЕНТА
//----------------------------------------------------------------------------------------
if(Action.equals("1")){
	//редактирование узла
	  ...
	  //определяем тип (если это не заимствованная)
	  if(!Type.equals("4")){
	  ...
	  // Выводим переданные параметры на экран, чтобы Ире было легче тестить :)
...
<body id="dt_example" onload=selChange()  background="images/background.png">
 <form action="edit.jsp" method="GET" name=form1>
	<div class="full_width big" align=center>Редактирование</div>
	...
	<table border=0>	
		<tr>
			...
			<td>
				<select name="STATUS" >
				 <%
				 	if(!STATUS.equals("Проработка"))
						out.println("<option title=\"Проработка\" style=\"background-color: #FFFAFA\">Проработка</option>");
				 	else
				 		out.println("<option selected title=\"Проработка\" style=\"background-color: #FFFAFA\">Проработка</option>");
				 	if(!STATUS.equals("Разрешено чертить"))
				 		out.println("<option title=\"Разрешено чертить\" style=\"background-color: #FFFF00\">Разрешено чертить</option>");
				 	else
				 		out.println("<option selected title=\"Разрешено чертить\" style=\"background-color: #FFFF00\">Разрешено чертить</option>");
				 	if(!STATUS.equals("Чертеж готов"))
				 		out.println("<option title=\"Чертеж готов\" style=\"background-color: #97FFFF\">Чертеж готов</option>");
				 	else
				 		out.println("<option selected title=\"Чертеж готов\" style=\"background-color: #97FFFF\">Чертеж готов</option>");
				 	if(!STATUS.equals("Выдано в ЭП"))
				 		out.println("<option title=\"Выдано в ЭП\" style=\"background-color: #66CDAA\">Выдано в ЭП</option>");
				 	else
				 		out.println("<option selected title=\"Выдано в ЭП\" style=\"background-color: #66CDAA\">Выдано в ЭП</option>");
				 	if(!STATUS.equals("Завод-калька"))
				 		out.println("<option title=\"Завод-калька\" style=\"background-color: #FFBBFF\">Завод-калька</option>");
				 	else
				 		out.println("<option selected title=\"Завод-калька\" style=\"background-color: #FFBBFF\">Завод-калька</option>");
				 	if(!STATUS.equals("Завод - разрешение"))
				 		out.println("<option title=\"Завод - разрешение\" style=\"background-color: #AB82FF\">Завод - разрешение</option>");
				 	else
				 		out.println("<option selected title=\"Завод - разрешение\" style=\"background-color: #AB82FF\">Завод - разрешение</option>");
				 	if(!STATUS.equals("Завод - извещение"))
				 		out.println("<option title=\"Завод - извещение\" style=\"background-color: #FFFACD\">Завод - извещение</option>");
				 	else
				 		out.println("<option selected title=\"Завод - извещение\" style=\"background-color: #FFFACD\">Завод - извещение</option>");
				 	if(!STATUS.equals("Аннулирован"))
				 		out.println("<option title=\"Аннулирован\" style=\"background-color: #6495ED\">Аннулирован</option>");
				 	else
				 		out.println("<option selected title=\"Аннулирован\" style=\"background-color: #6495ED\">Аннулирован</option>");
				 	if(!STATUS.equals("Корректировка"))
				 		out.println("<option title=\"Корректировка\" style=\"background-color: #FF3030\">Корректировка</option>");
				 	else
				 		out.println("<option selected title=\"Корректировка\" style=\"background-color: #FF3030\">Корректировка</option>");
				  %>
				</select>
			</td>
			<!-- РАЗРАБОТЧИК CREO -->
