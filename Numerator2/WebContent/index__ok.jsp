...
<table border=0 CELLPADDING=0 CELLSPACING=0 align="center">
	<tr>
		...
		if(SelectedItem.equals("")){
			...
			if(lSelectedTreeCount > 0){
				out.println("<td valign=top>");
				out.println("<a href=\"index.jsp?SelectedItem=" + lSelectedTree.get(0) + "\">xxx<img src=\"images/back.png\" name=Strelka onMouseOver=\"changeImg4('images/back2')\" onMouseOut=\"changeImg4('images/back')\" border=0 title=\"Назад\" width=20 height=20></a>");
				out.println("</td>");
			}
			if(!SelectedItem.equals("")){
				out.println("<td valign=top>");
				out.println("&nbsp;&nbsp;");
				out.println("<a href=\"percent_info.jsp?SelectedItem=" + URLEncoder.encode(SelectedItem,"windows-1251") + "\">xxx<img name=PictInfo width=20 height=20 src=\"images/percent.png\" onMouseOver=\"changeImgPictInfo('images/percent2')\" onMouseOut=\"changeImgPictInfo('images/percent')\" title=\"Подробная статистика по узлу\" border=0></a>");
				out.println("</td>");
			}
		}
		%>
